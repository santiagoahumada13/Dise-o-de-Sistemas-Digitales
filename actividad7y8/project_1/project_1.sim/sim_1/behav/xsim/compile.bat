...
REM
REM Generated by Vivado on Sun Nov 09 21:18:14 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj padovan_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj padovan_tb_vlog.prj -log xvlog.log
