...
REM
REM Generated by Vivado on Sun Nov 09 23:49:56 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj moser_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj moser_tb_vlog.prj -log xvlog.log
