...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/uart/uart/uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_test_top.tcl
