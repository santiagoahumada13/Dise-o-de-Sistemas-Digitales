...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/uart/uart/uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_test_top.tcl -notrace
