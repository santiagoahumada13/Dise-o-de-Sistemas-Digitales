...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/clase24sept/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_top.tcl -notrace
