...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/clase24sept/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_top.tcl
