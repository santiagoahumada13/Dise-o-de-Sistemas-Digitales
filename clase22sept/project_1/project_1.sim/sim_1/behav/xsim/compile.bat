...
REM
REM Generated by Vivado on Wed Sep 24 01:36:25 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj lock_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lock_tb_vlog.prj -log xvlog.log
