...
REM
REM Generated by Vivado on Wed Sep 17 13:23:22 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj fp_add_sim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fp_add_sim_vlog.prj -log xvlog.log
