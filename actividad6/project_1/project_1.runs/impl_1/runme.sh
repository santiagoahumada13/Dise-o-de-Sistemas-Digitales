...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/actividad6/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gdc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gdc_top.tcl -notrace
