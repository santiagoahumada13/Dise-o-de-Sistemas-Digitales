...
REM
REM Generated by Vivado on Tue Oct 21 23:39:28 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj gdc_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj gdc_tb_vlog.prj -log xvlog.log
