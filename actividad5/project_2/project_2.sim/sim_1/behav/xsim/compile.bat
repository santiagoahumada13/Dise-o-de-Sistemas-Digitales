...
REM
REM Generated by Vivado on Thu Oct 16 01:12:29 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj debounce_count_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj debounce_count_tb_vlog.prj -log xvlog.log
