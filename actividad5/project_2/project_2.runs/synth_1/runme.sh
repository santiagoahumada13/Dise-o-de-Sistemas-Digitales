...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/actividad5/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debounce_count_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debounce_count_top.tcl
