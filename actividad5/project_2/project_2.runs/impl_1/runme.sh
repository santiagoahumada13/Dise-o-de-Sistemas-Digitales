...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/actividad5/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debounce_count_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source debounce_count_top.tcl -notrace
