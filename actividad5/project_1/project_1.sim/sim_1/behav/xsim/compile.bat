...
REM
REM Generated by Vivado on Sun Oct 12 15:23:18 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj edge_detect_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj edge_detect_tb_vlog.prj -log xvlog.log
