...
HD_PWD='C:/Users/santiago/Desktop/Diseno de Sistemas Digitales/actividad5/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_detect_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_detect_top.tcl
